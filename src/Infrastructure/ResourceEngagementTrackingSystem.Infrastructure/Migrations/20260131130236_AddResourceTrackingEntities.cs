...
{
    /// <inheritdoc />
    public partial class AddResourceTrackingEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        RecruitmentType = table.Column<int>(type: "int", nullable: false),
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_RecruitmentRecords", x => x.Id);
                    }
                )
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        InvoicedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                        InvoiceNumber = table
                    ...
                    constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            name: "FK_BillingRecords_Employees_EmployeeId",
                        ...
                        table.ForeignKey(
                            name: "FK_BillingRecords_Projects_ProjectId",
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        ProjectId = table.Column<int>(type: "int", nullable: false),
                        EmployeeId = table.Column<int>(type: "int", nullable: false),
                        PlannedDeliveryDate = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: false
                        ),
                        ActualDeliveryDate = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: true
                        ),
                        EstimatedEffort = table.Column<decimal>(
                            type: "decimal(10,2)",
                            nullable: false
                        ),
                        ActualEffort = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        AllocationPercentage = table.Column<decimal>(
                            type: "decimal(5,4)",
                            nullable: false
                        ),
                        Role = table
                    ...
                    constraints: table =>
                    {
                        table.PrimaryKey("PK_StaffingRecords", x => x.Id);
                        table.ForeignKey(
                            name: "FK_StaffingRecords_Employees_EmployeeId",
                            column: x => x.EmployeeId,
                            principalTable: "Employees",
                            principalColumn: "Id",
                            onDelete: ReferentialAction.Cascade
                        ...
                        table.ForeignKey(
                            name: "FK_StaffingRecords_Projects_ProjectId",
                            column: x => x.ProjectId,
                            principalTable: "Projects",
                            principalColumn: "Id",
                            onDelete: ReferentialAction.Cascade
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillingRecords_EmployeeId",
                table: "BillingRecords",
                column: "EmployeeId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_BillingRecords_ProjectId",
                table: "BillingRecords",
                column: "ProjectId"
            );
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffingRecords_EmployeeId",
                table: "StaffingRecords",
                column: "EmployeeId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_StaffingRecords_ProjectId",
                table: "StaffingRecords",
                column: "ProjectId"
            );
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "RecruitmentRecords");

            migrationBuilder.DropTable(name: "StaffingRecords");
