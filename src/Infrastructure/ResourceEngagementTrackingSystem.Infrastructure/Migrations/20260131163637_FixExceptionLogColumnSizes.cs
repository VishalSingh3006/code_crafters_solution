...
{
    /// <inheritdoc />
    public partial class FixExceptionLogColumnSizes : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        AllocationStart = table.Column<DateTime>(
                            type: "datetime(6)",
                            nullable: false
                        ),
        ...
        {
            migrationBuilder.DropTable(name: "ResourceAllocations");

            migrationBuilder.DropTable(name: "EngagementPositions");
