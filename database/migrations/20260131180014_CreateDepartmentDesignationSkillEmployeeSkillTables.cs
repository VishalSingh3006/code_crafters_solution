...
namespace ResourceEngagementTrackingSystem.Infrastructure.Migrations
{
    ...
    public partial class CreateDepartmentDesignationSkillEmployeeSkillTables : Migration
    {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        ProficiencyLevel = table.Column<int>(
                            type: "int",
                            nullable: false,
                            defaultValue: 0
                        ), // Beginner
                ...
                {
                    {
                        ...
                        1,
                        1,
                        new DateTime(2026, 1, 31, 18, 0, 14, 0, DateTimeKind.Utc),
                        new DateTime(2026, 1, 31, 18, 0, 14, 0, DateTimeKind.Utc),
                    },
                    {
                        2,
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "EmployeeCode", table: "Employees");

            migrationBuilder.DropColumn(name: "Phone", table: "Employees");

            migrationBuilder.DropColumn(name: "DateOfJoining", table: "Employees");

            migrationBuilder.DropColumn(name: "DateOfBirth", table: "Employees");

            migrationBuilder.DropColumn(name: "ManagerId", table: "Employees");

            migrationBuilder.DropColumn(name: "EmploymentType", table: "Employees");
        }
    }
}
