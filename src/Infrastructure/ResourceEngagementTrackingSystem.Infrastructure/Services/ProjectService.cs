...
namespace ResourceEngagementTrackingSystem.Infrastructure.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public async Task<ProjectDto> GetByIdAsync(int id)
        {
            ...
            return new ProjectDto { Id = p.Id, Name = p.Name, Description = p.Description, ClientId = p.ClientId };
        }
        public async Task<ProjectDto> CreateAsync(CreateProjectDto dto)
        {
            var p = new Project { Name = dto.Name, Description = dto.Description, ClientId = dto.ClientId };
