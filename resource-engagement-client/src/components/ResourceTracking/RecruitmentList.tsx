                  ...
                  {records.length === 0 ? (
                    ...
                    records.map((record) => (
                      <tr key={record.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 border-b">
                          {record.numberOfOpenings}
                        </td>
                        <td className="px-4 py-2 border-b">
                          {record.openDate?.split("T")[0]}
                        </td>
                        <td className="px-4 py-2 border-b">
                          {record.postingDate?.split("T")[0]}
                        </td>
                        <td className="px-4 py-2 border-b">
                          {record.closeDate?.split("T")[0]}
                        </td>
                        <td className="px-4 py-2 border-b">
                          <span
                            className={`px-2 py-1 rounded text-xs font-semibold ${
                              record.status === RecruitmentStatus.Open
                                ? "bg-green-100 text-green-800"
                                : record.status === RecruitmentStatus.InProgress
                                  ? "bg-yellow-100 text-yellow-800"
                                  : record.status === RecruitmentStatus.Closed
